...
const assignment    = require('../lib/report/type/assignment')
const cat           = require('../lib/report/type/cat')
const { compose }   = require('../../../helpers').structures
const { data, raw } = require('./data/classify.data.js')
const lit           = require('../lib/report/type/lit')
