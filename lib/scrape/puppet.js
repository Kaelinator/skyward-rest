...
const history = ({ skyward }) => {
  return skyward.click('a[data-nav="sfacademichistory001.w"]')
    .then(() => skyward.waitForSelector('.fixedWrap'))
    .then(() => skyward.$$eval('div[id^="grid_gradeGrid"]', grabInner))
}
